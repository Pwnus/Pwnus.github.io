...
categories: [CTF-Time]
tags:
  [ctf,forensics, dfir, foremost, dwg, AutoCAD, hex, MThd, MIDI, pretty_midi, xor, DXF, Sonic Visualizer, spectrogram, png, Morse, steganography, steghide, adi, enc, vscode, extension, javascript, FTK Imager, PBKDF2, AES-CBC]
math: true
---
